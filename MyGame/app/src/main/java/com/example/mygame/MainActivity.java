...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initGame();
        tv_socer.setText("我移动"+String.valueOf(socer)+"步");
		...
		btnrestart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 initGame();
				 socer = 0 ;
				 tv_socer.setText("我移动了"+String.valueOf(socer)+"步");
			}
		});
    }
	...
	protected void left() {
		...
		int exchanged;
		if(numzero%3==0){
	    mVibrator.vibrate( new long[]{100,10,100,200}, -1);
		}else{
	...
	public void overGame(){
       ...
       if(total==7&&number[8]==0){
		   Toast.makeText(MainActivity.this, "恭喜你成功了！", 0).show();
		   for(int i=0;i<9;i++){
	        	number[i]=DataHelper.number[i];
	        }
		   socer = 0 ;
